...
class Drink {
    ...
    static initData() {
        ...
        Drink.add(new Drink('Drnink2', 30, 'slodki', [{ingredient: ing2, quantity: 50}, {ingredient: ing3, quantity: 100}], 15, 'przykładowy opis drinka', `../img/Drink2.jpg`))
        Drink.add(new Drink('Drnink3', 25, 'slodki', [{ingredient: ing1, quantity: 34}, {ingredient: ing2, quantity: 36}], 23, 'przykładowy opis drinka', `../img/Drink3.jpg`))
